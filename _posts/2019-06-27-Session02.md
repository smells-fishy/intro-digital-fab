...
<img src="blink_arduino.png" alt="Blink program code" style="height: 200px; max-width: 48%">
<img src="ten_blink.png" alt="Blink program code" style="height: 200px; max-width: 48%"> 
