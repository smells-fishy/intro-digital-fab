...
<p class="collapsibleLab1">Lab 1 (June 26)</p>

<div markdown="1" id="Lab1">
...
<p class="collapsibleLab1" style="color: blue; font-size: 16px; padding:0px;">Minimize</p>

</div>

<p class="collapsibleClass2">Class 2 (June 27)</p>

<div markdown="1" id="Class2">

During Thursday's lecture, we explored the functions of voltmeters and how to use the Arduino board as a voltmeter. First, we used voltmeters to measure the voltage across the circuits we built during

</div>

<script>

var coll = document.getElementsByClassName("collapsibleLab1");
var i;
...
var coll = document.getElementsByClassName("collapsibleClass2");
var i;

for (i = 0; i < coll.length; i++) {
  coll[i].addEventListener("click", function() {
    this.classList.toggle("active");
    var content = document.getElementById("Class2");
    if (content.style.display === "block") {
      content.style.display = "none";
      this.classList.toggle("active");
    } else {
