...
This program allows for multiple functions to run at the same time via calling in the void loop(). Each LED has its own timeOn variable to track how long it has been on in order to calculate when to switch next.
